...
Original file is located at
    https://colab.research.google.com/drive/1m6gDUxSZ6vy27NgEje_ZoyOJrfucev65
...
st.title('Predicción de inversión en una tienda de videojuegos de Jer0s1')

Edad = st.slider('Edad', min_value=14, max_value=67, value=20, step=1)
...
#No normalizo porque seleccione de modelo un Tree
